...
describe('Trade Service', () => {
  ...
  describe('getConvertQuote', () => {
    ...
    it('should throw when price not available', () => {
      ...
      expect(() => tradeService.getConvertQuote('XYZ', 'USDT', 1)).toThrow('Price not available');
    });
  ...
  describe('executeConvert', () => {
    ...
    it('should throw when insufficient balance', async () => {
      ...
      await expect(tradeService.executeConvert('user1', 'BTC', 'USDT', 1)).rejects.toThrow(
  ...
  describe('placeLimitOrder', () => {
    ...
    it('should throw when insufficient balance for buy', async () => {
      ...
      await expect(
        tradeService.placeLimitOrder('user1', 'BTC/USDT', 'buy', 50000, 0.1),
  ...
  describe('cancelOrder', () => {
    ...
    it('should throw when order not found', async () => {
      ...
      await expect(tradeService.cancelOrder('user1', 'invalid-id')).rejects.toThrow(
  ...
  describe('getOrders', () => {
    it('should get all orders for user', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(expect.stringContaining('WHERE user_id = $1'), [
        'user1',
      ]);
    });
    ...
    it('should filter by status when provided', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(expect.stringContaining('AND status = $2'), [
        'user1',
        'open',
      ]);
    });
