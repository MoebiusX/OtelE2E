...
describe('Public Routes', () => {
  ...
  describe('GET /api/public/trades', () => {
    it('should return public trades', async () => {
      ...
      const res = await request(app).get('/api/public/trades');
    ...
    it('should respect limit parameter', async () => {
      ...
      await request(app).get('/api/public/trades?limit=50');
    ...
    it('should use default limit of 20', async () => {
      ...
      await request(app).get('/api/public/trades');
    ...
    it('should clamp limit to max 100', async () => {
      ...
      await request(app).get('/api/public/trades?limit=200');
    ...
    it('should clamp limit to min 1', async () => {
      ...
      await request(app).get('/api/public/trades?limit=0');
  ...
  describe('GET /api/public/trace/:traceId', () => {
    it('should return trace details', async () => {
      ...
      const res = await request(app).get('/api/public/trace/trace-123');
    ...
    it('should return 404 for non-existent trace', async () => {
      ...
      const res = await request(app).get('/api/public/trace/nonexistent');
  ...
  describe('GET /api/public/metrics', () => {
    it('should return transparency metrics', async () => {
      ...
      const res = await request(app).get('/api/public/metrics');
