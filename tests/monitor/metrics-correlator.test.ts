...
describe('MetricsCorrelator', () => {
  ...
  describe('correlate', () => {
    it('should return correlated metrics structure', async () => {
      const result = await correlator.correlate('anomaly-123', 'kx-wallet', new Date());
    ...
    it('should set correct anomaly ID', async () => {
      const result = await correlator.correlate('test-anomaly', 'kx-wallet', new Date());

      expect(result.anomalyId).toBe('test-anomaly');
    });

    it('should set correct service', async () => {
      const result = await correlator.correlate('anomaly-1', 'kx-exchange', new Date());
    ...
    it('should calculate time window correctly', async () => {
      ...
      const result = await correlator.correlate('anomaly-1', 'kx-wallet', timestamp);
    ...
    it('should handle connection errors gracefully', async () => {
      ...
      const result = await correlator.correlate('anomaly-1', 'kx-wallet', new Date());
