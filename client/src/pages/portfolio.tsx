              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-purple-100/70 mb-4 max-w-lg">
                    Experience{' '}
                    <span className="text-cyan-400 font-semibold">Proof of Observability</span> -
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {walletsData?.wallets.map((wallet) => {
              const config = ASSET_CONFIG[wallet.asset] || {
                icon: '?',
              ...
              return (
                <Card
                  key={wallet.asset}
                  className="bg-slate-800/50 border-cyan-500/30 hover:border-cyan-400/50 transition-all backdrop-blur"
                >
