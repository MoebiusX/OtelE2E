                      ...
                      <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            >
                              {isOrder ? `${order?.side} ${order?.pair}` : 'Transfer BTC'}
                            </span>
                            <Badge
                              variant="outline"
                            ...
                            {isOrder ? (
                              <>
                                ...
                                {order?.fillPrice?.toLocaleString() ||
                                  priceData?.BTC.toLocaleString() ||
                                  'Market'}
                              </>
                            ) : (
                              <>
                                {transfer?.amount?.toFixed(6)} BTC •{transfer?.fromUserId} →{' '}
                                {transfer?.toUserId}
                              </>
                            )}
                          </div>
        ...
        <Card className="mt-8 bg-gradient-to-r from-cyan-900/20 to-indigo-900/20 border-cyan-500/20">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-cyan-100 mb-1">Proof of Observability™</h3>
                <p className="text-cyan-100/60 text-sm">
                  Every transaction has a unique Trace ID. Click "View Trace" to see exactly how
                  your order was processed - from API gateway to database. This is real-time
                  transparency, not just a promise.
                </p>
                <Button
                  variant="link"
