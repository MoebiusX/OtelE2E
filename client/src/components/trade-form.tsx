              ...
              <div className="flex items-center justify-between text-sm">
                ...
                {execution && (
                  <span className="font-bold text-emerald-400">
                    @ ${execution.fillPrice?.toLocaleString()}
                  </span>
                )}
              </div>
              {execution && (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-slate-300 mt-1">
                  {lastTrade.side} {lastTrade.quantity.toFixed(6)} BTC @ $
                  {lastTrade.fillPrice.toLocaleString()}
                </p>
                <a
        ...
        <div className="grid grid-cols-2 gap-3 p-3 bg-slate-800 rounded-lg">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-mono font-bold text-orange-400">{(wallet?.btc ?? 0).toFixed(6)}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
