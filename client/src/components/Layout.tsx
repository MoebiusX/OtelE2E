            ...
            <div className="flex items-center gap-3">
              {user ? (
                <>
                  ...
                  <Badge
                    variant="outline"
                    className="border-emerald-500/30 text-emerald-400 hidden sm:flex bg-emerald-500/5"
                  >
                    Verified
                  </Badge>
                  <Button
      ...
      <footer className="border-t border-cyan-500/20 bg-slate-900/80 backdrop-blur-lg mt-auto">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-cyan-100/70 text-sm mb-2">
                The First Crypto Exchange with Proof of Observability™
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="/" className="text-cyan-100/60 hover:text-cyan-400 transition-colors">
                    Live Dashboard
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-cyan-500/20 mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-cyan-100/50 text-xs">© 2026 Krystaline. All rights reserved.</p>
            <p className="text-cyan-100/40 text-xs">Last updated: {new Date().toLocaleString()}</p>
          </div>
        </div>
      </footer>
    </div>
