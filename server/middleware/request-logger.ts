...
export function requestLogger(req: Request, res: Response, next: NextFunction): void {
  ...
  res.on('finish', () => {
    ...
    const shouldLogBody = req.method !== 'GET' || res.statusCode >= 400 || duration > 1000; // Log slow requests
 ...
 */
export function requestLoggerWithExclusions(req: Request, res: Response, next: NextFunction): void {
